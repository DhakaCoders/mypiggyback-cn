...
Constants->>
*/
defined('THEME_NAME') or define('THEME_NAME', 'mypiggyback');
...
if( !function_exists('cbv_theme_setup') ){
	...
	function cbv_theme_setup(){
	  ...
	  load_theme_textdomain( 'mypiggyback', get_template_directory() . '/languages' );
...
Includes->>
*/
include_once(THEME_DIR .'/account/account-functions.php');
