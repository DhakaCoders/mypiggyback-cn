          ...
          <div class="col-sm-12">
            <div class="block-800">
              ...
              <div class="customer-details">
                ...
                <div class="job-points">
                  <ul>
                    <li><strong>Name:</strong> John Deo</li>
                    <li><strong>Email:</strong> johndeo@gmail.com</li>
                    <li><strong>Phone:</strong> 012345</li>
                  </ul>
                </div>
              </div>
              <p><small>Dev note : Customer details only for admin view</small></p>
              <div class="gap-50"></div>
