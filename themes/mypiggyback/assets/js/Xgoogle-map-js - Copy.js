(function($) {
    ...
    function setDestination() {
      var options = {
        ...
        google.maps.event.addListener(from_places, 'place_changed', function () {
            ...
            var from_components = from_place.address_components;
            var from_address = from_place.formatted_address;
            $('#origin').val(from_address);
            console.log(from_components);
            console.log(from_components[5]['long_name']);
        });

        google.maps.event.addListener(to_places, 'place_changed', function () {
            var to_place = to_places.getPlace();
            var to_components = to_place.address_components;
            var to_address = to_place.formatted_address;
            
            $('#destination').val(to_address);
            console.log(to_components);
            ...
            setSourceDestination(origin, destination);
    ...
    function setSourceDestination(origin, destination) {
